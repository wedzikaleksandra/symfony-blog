...
class CategoryServiceTest extends KernelTestCase
{
    ...
    public function testSave(): void
    {
        ...
        $expectedCategory->setTitle('Test Category 1');
        $expectedCategorySlug = 'test-category-1';
        ...
        $this->assertEquals($expectedCategorySlug, $resultCategory->getSlug());
    ...
    public function testDelete(): void
    {
        ...
        $categoryToDelete->setTitle('Test Category 2');
    ...
    public function testFindById(): void
    {
        // given
        $expectedCategory = new Category();
        $expectedCategory->setTitle('Test Category 3');
